...
import { FaKey, FaCog, FaArrowLeft } from "react-icons/fa";
  ...
  return (
    <div className="desert-adv-container">
      <div className="desert-adv-header">
        <button className="desert-adv-back" onClick={() => navigate("/main")}><FaArrowLeft /></button>
        <div className="desert-adv-level">Level {levels[currentGameLevel].level}</div>
        <button className="desert-adv-gear"><FaCog /></button>
      </div>
